...
# We are trying to figure out what models
# describe the first decade of the internet usage (1990-1999)
...
# From our analysis, both the logistic and exponentional models
# do/does fairly good job of fitting the pattern of the internete usage in the USA
# from 1990-1999, as shown by R-squared values greater than 0.95
# If we look ahead to 2006, however, we see that the logistic model
# has a better long-term fit
# This model predicted 127.5 million users in 2006, with residuals of 78.2 million
# The exponential model predicted far more users
# It appears that the number of users grew rapidly at first but
# then began to level off over time